...
public class Move {
	...
	/**
	 * Constructs a player generated move
	 * 
	 * @param pData
	 *            a series of squares the piece comes to
	 */
	public Move(Vector<Integer> pData) {
		this.mType = MoveType.MOVE_PLAYER.getInternalValue();
        this.mData.setSize(0);
	...
	public String toString() {
		...
		if (this.mType >= MoveType.MOVE_JUMP.getInternalValue()) {
			delimiter = "x";
		} else if (this.mType == MoveType.MOVE_NORMAL.getInternalValue()) {
			delimiter = "-";
		} else {
			//Player generated move
			delimiter = "+";
		}
	...
	public boolean equals(final Move pRH) {
		if (this.mType != pRH.mType) {
			if (this.mType != MoveType.MOVE_PLAYER.getInternalValue() &&
			pRH.mType != MoveType.MOVE_PLAYER.getInternalValue()) {
				//System.err.println("Return from equals false1");
				return false;
			}
		} // End if

		if (this.mData.size() != pRH.mData.size()) {
			//System.err.println("Return from equals false2");
			return false;
		} // End if

		for (int i = 0; i < this.mData.size(); i++) {
			if (this.mData.elementAt(i) != pRH.mData.elementAt(i)) {
				//System.err.println("Return from equals false3");
				return false;
			} // End if
		} // End for

		//System.err.println("Return from equals true");
		return true;
	} // End equals
	...
	public enum MoveType {
		...
		MOVE_PLAYER(-6);	// / a player generated move of unknown type
